...
namespace QR_Project_6.Models
{
    public abstract class QR
    {
        ...
        public virtual Nullable<int> QRID { get; set; }
        public string UserNameID { get; set; }
        public Nullable<System.DateTime> Fecha { get; set; }
        public string Comentario { get; set; }
        ...
        //public abstract ICollection<Respuesta_Empleado> Respuesta_Empleado { get; set; }
        //[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        //public abstract ICollection<Respuesta_Cliente> Respuesta_Cliente { get; set; }
